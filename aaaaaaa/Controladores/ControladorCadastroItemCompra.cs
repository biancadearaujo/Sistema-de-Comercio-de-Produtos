...
{
    class ControladorCadastroItemCompra
    {
        public void retirarDoEstoque(ItemCompra item)
        {
            int qtdEstoque = 0;
            int novaQtd = 0;
        ...
        public void reestocar(ItemCompra item)
        {
            int qtdEstoque = 0;
            int novaQtd = 0;
        ...
        public virtual void incluir(ItemCompra item)
        {
            try
            {
